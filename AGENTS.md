...
*最后更新: 2026-06-26 - v0.23.49 推理模型思考链 JSON 提取修复（strip_reasoning_blocks + 空对象跳过）+ v0.23.48 括号匹配修复 trailing characters + v0.23.47 模型前实时连接探测 + v0.23.46 状态提示使用模型名称 + v0.23.45 IngestPipeline 静默化*
