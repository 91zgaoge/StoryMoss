# StoryForge (草苔) v0.26.21 架构文档

> 本文档反映 v0.26.21 最新架构状态（2026-07-06）
> **v0.26.21 格式修复**：修复 v0.26.19 CI `cargo +nightly fmt -- --check` 失败（`ParallelWorldOutlineCharacterStep` doc 注释超 `max_width=100`，自动换行）。仅注释格式变更。
