tauri::generate_handler![
    ...
    llm::commands::get_context_health,
    llm::commands::get_workflow_logs,
    llm::commands::get_workflow_logs_parsed,
    ...
    agency::commands::agency_reject_promotion,
    // Auth commands
