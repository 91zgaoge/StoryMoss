...
# StoryForge (草苔) v0.7.4 - AI 导演式小说创作系统
...
>
> **v0.7.4 最新更新（2026-05-22）**：幕后世界构建页面（核心概念 / 世界规则 / 历史背景 / 文化体系一站式编辑）+ 世界-场景自动关联（场景 setting 变更自动同步到世界观，遵循"场景增世界增，场景减世界减"双向关联原则）+ 内置经典作家 DNA 扩展至 52 种（新增中国/日本/欧美文学 32 位作家 + 8 种类型文学风格）。
>
