...
[![Version](https://img.shields.io/badge/version-v0.23.72-gold)](./CHANGELOG.md)
[![License](https://img.shields.io/badge/license-ISC-blue.svg)](./LICENSE)

**最新动态**：v0.23.72 全文重复根治——后端空白归一化+TimeSliced路径sanitize全覆盖+前端GEN-TEXT诊断日志。v0.23.66 模型角色分配+任务分型温度覆盖。
